    ...
    <table class="table">
        ...
        <tbody>
            <tr v-for="(user, index) in users" :key="index">
                ...
                <td>
                    <input type="checkbox" v-model="user.isAdmin" :disabled="!user.editing" class="form-check-input">
                </td>
                <td>
                    ...
                    <template v-else>
                        <button @click="editUser(index)" class="btn btn-primary" style="min-width: 150px;">Edit</button>
